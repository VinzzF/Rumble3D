...
namespace r3
{
		...
		glm::mat3 inverseInertiaTensor[2]) const
	{
		...
		// Erstelle Vektor f�r die Geschwindigkeits�nderung in World-Koordinaten
		// f�r eine Impulseinheit in Richtung Kontaktnormale:
		...
		// Addition der linearen Komponente der Geschwindigkeits�nderung:
		...
		if(second->hasFiniteMass())
		{
			...
			// Addition der linearen Komponente der Geschwindigkeits�nderung aus der Rotation:
											   ...
											   glm::vec3 rotationChange[2]) const
	{
		...
		// Zwischenspeichern der inversen Tr�gheitstensoren in Weltkoordinaten
